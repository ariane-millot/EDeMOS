...
for i in range(2):
    ...
    include = (data_subregions[column_name] > 0)
    ...
    if make_figure:
        ...
        plt.scatter(data_subregions['rwi'][include], energy_demand[i, include], alpha=al, marker='o', s=1, c='orange',
                    edgecolors='None')
    ...
    if make_figure:
        ...
        outfile = 'household_groups_' + region_type[i].lower() + '_withweight.png'
