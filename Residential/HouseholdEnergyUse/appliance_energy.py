...
# Read-in the data from the surveyof households
...
# Create filter to avoid including houses that don't even have electriciy
has_electricity = appliance_use[:,0]>0

# set counter to folow tiers in loop below
t = -1
