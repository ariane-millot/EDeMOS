...
def plot_sector_demand_map(grid_gdf, col_to_plot, app_config, admin_gdf_param, region_gdf_param, sector_name,
                           fig_size=(25, 15)):
    print(f"Plotting {sector_name} Demand map...")
    ...
    plt.savefig(app_config.RESIDENTIAL_OUTPUT_DIR / f'map_{sector_name}_demand_log_{app_config.COUNTRY}.png', bbox_inches='tight')
    # plt.show()
