...
TARGET_CRS_METERS = "EPSG:32736" # Used for grid line buffering (UTM Zone 36S)
...
USGS_TABLE = "myb3-2020-21-Uganda-advrel.xlsx"
...
MV_LINES_SHP = "uganda-electricity-transmission-network/Uganda Electricity Transmission Network.shp"
HV_LINES_SHP = MV_LINES_SHP

# Census data files
# The file should contain the following data: 'region', 'HH_urban', 'HH_rural','size_HH_urban', 'size_HH_rural'
PROVINCE_DATA_AVAILABLE = False
CENSUS_PROVINCE_CSV = Path("Census") / COUNTRY /"Census_UGA.csv"
CENSUS_NATIONAL_CSV = Path("Census") / COUNTRY / "Census_UGA_National.csv"
...
# -----------------------------------------------------------------------------
DHS_HH_SURVEY_FILE = 'UGHR91DT/UGHR91FL'
DHS_SERVICES_SURVEY_FILE = 'UGIR7BDT/UGIR7BFL'
